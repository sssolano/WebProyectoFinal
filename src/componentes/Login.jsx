...
function Login() {
  ...
  async function registrarUsuario(email, password, rol) {
    const infoUsuario = await createUserWithEmailAndPassword(
      ...
      //genera una promesa regresa al usuario cuando ya haya recibido la info
      return usuarioFirebase;
    });

    const docReferenciaUsuario = doc(
      firestore,
      ...
      <div className="row align-items-start" style={{ minHeight: "80vh" }}>
        ...
        <div className="col-md-6 d-flex justify-content-center">
          <div
            ...
            style={{
              width: "25rem",
              boxShadow: "0 2rem 5rem rgba(0, 128, 0, 0.5)",
              marginTop: "0px",
              padding: "20px",
            }}
          >
            <img
              src={ImagenPerfil}
              alt="Perfil"
              style={{ width: "300px", marginLeft: "25px", padding: "4px" }}
            />
